...
const openai = new OpenAI({
  apiKey: "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",
});
...
export default function AIBuilder({ onSave }: Props) {
